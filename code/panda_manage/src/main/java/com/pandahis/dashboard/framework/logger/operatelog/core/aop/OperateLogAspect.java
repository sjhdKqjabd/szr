package com.pandahis.dashboard.framework.logger.operatelog.core.aop;
    ...
    private static void fillMethodFields(SysOperateLogCreateReqVO operateLogVO,
        ...
        if (result != null) {
            if (result instanceof CommonResult) {
                ...
                operateLogVO.setResultCode(GlobalErrorCodeConstants.SUCCESS.getCode());
            }
        }
        // （异常）处理 resultCode 和 resultMsg 字段
        if (exception != null) {
            operateLogVO.setResultCode(GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR.getCode());
