...
import com.pandahis.dashboard.modules.tool.enums.codegen.ToolCodegenColumnHtmlTypeEnum;
import com.pandahis.dashboard.modules.tool.enums.codegen.ToolCodegenColumnListConditionEnum;
import com.pandahis.dashboard.modules.tool.enums.codegen.ToolCodegenTemplateTypeEnum;
...
public class ToolCodegenBuilder {
    ...
    private void initTableDefault(ToolCodegenTableDO table) {
        ...
        table.setClassComment(subBefore(table.getTableComment(), // 去除结尾的表，作为类描述
                '表', true));
        table.setAuthor("源码乐园"); // TODO 稍后改成创建人
