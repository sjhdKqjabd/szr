...
import com.pandahis.dashboard.modules.system.controller.permission.vo.menu.*;
import com.pandahis.dashboard.modules.system.convert.permission.SysMenuConvert;
...
public class SysMenuController {
    ...
    public CommonResult<List<SysMenuRespVO>> getMenus(SysMenuListReqVO reqVO) {
        ...
        return CommonResult.success(SysMenuConvert.INSTANCE.convertList(list));
    }
    ...
    public CommonResult<List<SysMenuSimpleRespVO>> getSimpleMenus() {
        ...
        // 排序后，返回个诶前端
        list.sort(Comparator.comparing(SysMenuDO::getSort));
        return CommonResult.success(SysMenuConvert.INSTANCE.convertList02(list));
    }
    ...
    public CommonResult<SysMenuRespVO> getMenu(Long id) {
        ...
        return CommonResult.success(SysMenuConvert.INSTANCE.convert(menu));
    }
