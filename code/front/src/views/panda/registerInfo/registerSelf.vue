  ...
  <div class="app-container">
    ...
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="医生姓名" prop="docName">
        <el-autocomplete    :trigger-on-focus="false"    placeholder="请输入医生姓名"
...
export default {
  ...
  created() {
    this.getList();
    this.initDepts();
    this.form.petId=this.userId;
    this.form.petName=this.userInfo.name;
  ...
  methods: {
    ...
    submitForm() {
      this.$refs["form"].validate(valid => {
        ...
        this.form=Object.assign(this.form,{petId:this.userId,petName:this.userInfo.name})
        // 修改的提交
