  ...
  <div class="app-container">
    ...
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="80px">
      ...
      <el-form-item label="接诊医生" prop="docName">
        <el-input v-model="queryParams.docName" placeholder="请输入接诊医生名" clearable size="small" @keyup.enter.native="handleQuery"/>
      </el-form-item>
      ...
      <el-form-item label="病人姓名" prop="petName">
        <el-input v-model="queryParams.petName" placeholder="请输入病人名称" clearable size="small" @keyup.enter.native="handleQuery"/>
      </el-form-item>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="接诊医生名" prop="docName">
          <el-input v-model="form.docName" placeholder="请输入接诊医生名" />
        </el-form-item>
        <el-form-item label="挂号科室" prop="deptName">
          <el-input v-model="form.deptName" placeholder="请输入挂号科室" />
        </el-form-item>
        <el-form-item label="病人名称" prop="petName">
          <el-input v-model="form.petName" placeholder="请输入病人名称" />
        </el-form-item>
        <el-form-item label="病人Id" prop="petId">
          <el-input v-model="form.petId" placeholder="请输入病人Id" />
        </el-form-item>
      </el-form>
